    ...
    WebkitBackdropFilter: "blur(12px)",
      ...
      <Toolbar className="flex justify-between items-center" sx={{px: {xs: "16px", md: "112px"}, py: "10px"}}>
        ...
        <Box display="flex" alignItems="center" sx={{gap: {xs: "8px", md: "16px"}}}>
          ...
          <Button sx={{display: {xs: "none", md: "flex"}, color: "rgb(255,255,255)", width: "96px", height: "36px", padding: "0", background: "linear-gradient(103.54deg, #EE2B2B 0%, #F34E1B 50%, #F8C630 100%)", boxShadow: "0px 10px 30px -10px rgba(243, 78, 27, 0.3)"}}>
            Enroll now
          </Button>
